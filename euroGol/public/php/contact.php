...
if(trim($name) == '') {
	...
	echo '<div class="error_message">Ingresó una dirección de correo electrónico no válida. Por favor intente de nuevo</div>';
	exit();
}
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<h3>Correo electrnico enviado con éxito</h3>";
